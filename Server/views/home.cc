...
std::string home::genText(const DrTemplateData& home_view_data)
{
	...
	home_tmp_stream << "    <style>\n";
	home_tmp_stream << "        .container {\n";
	home_tmp_stream << "            display: flex;\n";
	home_tmp_stream << "            flex-wrap: wrap;\n";
	home_tmp_stream << "        }\n";
home_tmp_stream<<"\n";
	home_tmp_stream << "        .chart {\n";
	home_tmp_stream << "            flex: 0 0 auto;\n";
	home_tmp_stream << "            width: 50%;\n";
	home_tmp_stream << "            height: 400px;\n";
	home_tmp_stream << "        }\n";
home_tmp_stream<<"\n";
	home_tmp_stream << "        @media (max-width: 992px) {\n";
	home_tmp_stream << "            .container {\n";
	home_tmp_stream << "                flex-direction: column;\n";
	home_tmp_stream << "            }\n";
home_tmp_stream<<"\n";
	home_tmp_stream << "            .chart {\n";
	home_tmp_stream << "                width: 100%;\n";
	home_tmp_stream << "            }\n";
	home_tmp_stream << "        }\n";
	home_tmp_stream << "    </style>    \n";
	home_tmp_stream << "</head>\n";
