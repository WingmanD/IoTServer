...
home_tmp_stream<<username;
	...
	home_tmp_stream << "    </div>\n";
	home_tmp_stream << "    <br>\n";
	home_tmp_stream << "    <h2>Status</h2>\n";
	home_tmp_stream << "    <div class=\"row\">\n";
	home_tmp_stream << "        <div class=\"col-auto text-end\">\n";
	home_tmp_stream << "            Measurements\n";
	home_tmp_stream << "        </div>\n";
	home_tmp_stream << "        <div class=\"col-auto\" id=\"statusMeasurements\"></div>\n";
	home_tmp_stream << "        <div class=\"col\"></div>\n";
	home_tmp_stream << "    </div>\n";
	home_tmp_stream << "    <br>\n";
	home_tmp_stream << "</div>\n";
	home_tmp_stream << "</body>\n";
...
home_tmp_stream<<"\n";
	...
	home_tmp_stream << "        elem.children[0].children[0].onclick = async function() {\n";
	home_tmp_stream << "            var res = await fetch(\n";
	home_tmp_stream << "                \"/alarm/clear?id=\" + alarm.id.id,\n";
	home_tmp_stream << "                { method: 'POST' }\n";
	home_tmp_stream << "            );\n";
	home_tmp_stream << "            if (res.status == 200) location.reload();\n";
	home_tmp_stream << "            else {\n";
	home_tmp_stream << "                alert(\"res.status\");\n";
	home_tmp_stream << "                console.log(alarm.id.id, res);\n";
	home_tmp_stream << "            }\n";
	home_tmp_stream << "        };\n";
...
home_tmp_stream<<"\n";
	...
	home_tmp_stream << "    document.getElementById(\"statusMeasurements\").textContent = measurements.client.active? \"🟢 Online\" : \"🔴 Offline\";\n";
	home_tmp_stream << "}\n";
home_tmp_stream<<"\n";
