...
home_tmp_stream<<"\n";
	...
	home_tmp_stream << "async function GET(url) {\n";
	home_tmp_stream << "    var res = await fetch(url);\n";
	home_tmp_stream << "    if (res.status == 200) return await res.json();\n";
	home_tmp_stream << "    else if (res.status == 401) {\n";
	home_tmp_stream << "        logout();\n";
	home_tmp_stream << "    } else {\n";
	home_tmp_stream << "        return {\n";
	home_tmp_stream << "            status: \"fetch \",\n";
	home_tmp_stream << "            errorCode: res.status.toString(),\n";
	home_tmp_stream << "            message: `Failed to GET ${url}`\n";
	home_tmp_stream << "        };\n";
	home_tmp_stream << "    }\n";
	home_tmp_stream << "}\n";
home_tmp_stream<<"\n";
	...
	home_tmp_stream << "    else if (res.status == 401) {\n";
	home_tmp_stream << "        alert(\"Error: Your session has likely expired, please log in again.\");\n";
	home_tmp_stream << "        logout();\n";
	home_tmp_stream << "    } else {\n";
	home_tmp_stream << "        alert(`Error: ${url} returned ${res.status}`);\n";
	home_tmp_stream << "        console.log(res);\n";
	home_tmp_stream << "    }\n";
	home_tmp_stream << "}\n";
home_tmp_stream<<"\n";
	home_tmp_stream << "async function LoadAlarms() {\n";
	home_tmp_stream << "    var alarms = await GET(\"/alarm/\");\n";
	home_tmp_stream << "    console.log(alarms);\n";
...
home_tmp_stream<<"\n";
	...
	home_tmp_stream << "    var measurements = await GET(\"/measurements/status\");\n";
...
home_tmp_stream<<"\n";
	...
	home_tmp_stream << "    var telemetry = await GET(\"/measurements/\");\n";
